...
const ContactCard = ({contact}:any) => {
    const {setSelectedUser} = useCurrentUserStore()
  ...
  return (
    <div onClick={handleSelectUser} className='flex w-full py-4 px-4 items-center gap-x-4 bg-transparent hover:bg-primary/10 cursor-pointer rounded-[10px]'>
